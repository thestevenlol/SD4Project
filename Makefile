...
MAIN_OBJ = main.o
OBJ = $(SRC_DIR)/fuzz.o $(SRC_DIR)/range.o $(SRC_DIR)/lex.o $(SRC_DIR)/io.o $(SRC_DIR)/testcase.o $(SRC_DIR)/target.o $(SRC_DIR)/generational.o $(SRC_DIR)/coverage.o $(SRC_DIR)/logger.o
